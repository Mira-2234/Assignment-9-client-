    ...
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="section-title mt-2 text-5xl text-green-700 font-bold mb-3">
            Success Stories
          </h2>
          <p className="text-gray-500 max-w-xl mx-auto text-sm">
            Hear from families who found their perfect pet through PawHome.
          </p>
        </div>
          ...
          {stories.map((s, i) => (
            ...
            >
              ...
              <div className="mt-4 pt-4 border-t border-gray-100 flex justify-between items-center">
                <span className="badge bg-primary-50 text-primary-600 text-xs font-semibold">
                  Adopted {s.pet}
                </span>
